        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>For more information Subscribe Below.</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">XPLORE.</a> All Right Reserved.

                    
                        Developed by <a class="border-bottom" href="#">Traffic Builder</a>
                    </div>
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-lg btn-primary btn-lg rounded-circle back-to-top"><i class="bi bi-arrow-up"></i></a>
